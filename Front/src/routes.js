...
import MinhaNovaPagina from "./views/test/MinhaNovaPagina";
...
// Custom Pages
const myNovaPagina = React.lazy(() => import("./views/test/MinhaNovaPagina"));
const uploadFiles = React.lazy(() => import("./views/upload/uploadFile"));
